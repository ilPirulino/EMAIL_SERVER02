...
email_password = 'wlbp kpds qtqr ximv' #password esclusiva per le email inviate con python
filepath = "C:\\Users\\Alessio\\PycharmProjects\\SMTPLIB_Try01\\.venv\\Report_prova02.5.pdf"

#email ricevitore
email_receiver = 'alebig2006@gmail.com'

#struttura effettiva dell'email
subject = "Prova invio email 01"

def Send_Email(fromadd, password, toadd, subject, file):
    link = "https://ilpirulino.github.io/EMAIL_SERVER02/"
    body = f"""
    Prova avvenuta con successo!<br><br>


    Link: <a href="{link}">Visita il sito</a>
    """
...
Send_Email(email_sender, email_password, email_receiver, subject, filepath)